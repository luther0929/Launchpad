...
const Optimize: React.FC = () => {
  ...
  const baseResume = useMemo(
    () => [
      ...
      "• Integrated Splite4 + BenGuide dashboards for LRT metrics",
  ...
  const [recs, setRecs] = useState<Recommendation[]>([
    ...
    },
    {
      id: "rec2",
      lineIndex: 11,
      title: "Quantify Splite4 integration",
      description: "Call out user scale to make results scannable.",
      beforeText: "• Integrated Splite4 + BenGuide dashboards for LRT metrics",
      afterText: "• Integrated Splite4 dashboards tracking 1,200+ users in BenGuide",
      decision: "none",
